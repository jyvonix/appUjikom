    ...
    <div class="mb-10 flex flex-col lg:flex-row lg:items-center justify-between gap-8">
        ...
        <div class="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div class="flex items-center gap-3 bg-white p-1.5 rounded-2xl border border-slate-100 shadow-sm">
                ...
                <a href="{{ route('admin.nilai.export') }}" class="h-12 w-12 bg-emerald-600 text-white rounded-xl flex items-center justify-center hover:bg-emerald-700 transition-all shadow-lg active:scale-95 transform">
                ...
                <button onclick="window.print()" class="h-12 w-12 bg-slate-900 text-white rounded-xl flex items-center justify-center hover:bg-emerald-600 transition-all shadow-lg active:scale-95 transform">
