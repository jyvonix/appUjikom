            ...
            <div class="mb-10 flex items-center gap-6">
                ...
                <div>
                    <nav class="flex mb-1 text-[8px] font-black uppercase tracking-[0.3em] text-slate-400">
                        ...
                        <span>New Repository Asset</span>
                    </nav>
                                    ...
                                    <div class="space-y-6 mb-8">
                                        ...
                                        <div>
                                            ...
                                            <select name="kesulitan" class="w-full px-5 py-4 bg-white/5 border-2 border-white/10 rounded-xl focus:bg-white/10 focus:border-blue-500 transition-all outline-none font-black text-white text-xs appearance-none cursor-pointer group">
                                                <option value="mudah" class="bg-slate-900 text-white font-bold" {{ old('kesulitan') == 'mudah' ? 'selected' : '' }}>MUDAH</option>
                                                <option value="sedang" class="bg-slate-900 text-white font-bold" {{ old('kesulitan') == 'sedang' ? 'selected' : 'active' }} selected>SEDANG</option>
                                                <option value="sulit" class="bg-slate-900 text-white font-bold" {{ old('kesulitan') == 'sulit' ? 'selected' : '' }}>SULIT</option>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="mb-10">
                                        <label class="block text-[8px] font-black text-blue-400 uppercase tracking-[0.2em] mb-3 ml-1 text-center">Kunci Jawaban</label>
                                        <div class="grid grid-cols-5 gap-2">
                                            @foreach(['A', 'B', 'C', 'D', 'E'] as $k)
                                            <label class="relative cursor-pointer group/opt">
                                                <input type="radio" name="jawaban_benar" value="{{ $k }}" class="peer hidden" required {{ old('jawaban_benar') == $k ? 'checked' : '' }}>
