    ...
    <div class="relative min-h-screen pb-20 bg-slate-50/30">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 pt-10">
            ...
            <div class="mb-10 flex items-center gap-6">
                <a href="{{ route('admin.modul.show', $soal->modul_id) }}" 
                            ...
                            <div class="bg-slate-900 rounded-[2.5rem] p-8 shadow-xl relative overflow-hidden border-t border-white/10">
                                <div class="relative z-10">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <a href="{{ route('admin.modul.show', $soal->modul_id) }}" class="block w-full py-3 text-slate-500 font-black text-center text-[9px] uppercase tracking-widest hover:text-white transition-all">
                                            Batalkan
                                        </a>
                                    </div>
                                </div>
