<x-admin-layout>
    <div class="relative min-h-screen pb-20 bg-slate-50/30">
        ...
        <form action="{{ route('admin.soal.update', $soal) }}" method="POST" enctype="multipart/form-data" class="px-4 sm:px-8">
            @csrf
            @method('PUT')
                    ...
                    <div class="bg-white/90 backdrop-blur-3xl rounded-[40px] md:rounded-[60px] p-8 md:p-14 border border-white shadow-[0_40px_100px_-20px_rgba(37,99,235,0.08)] group">
                        ...
                        <div class="mb-10">
                            ...
                            <div class="relative group/img">
                                ...
                                <label for="gambar" class="flex flex-col items-center justify-center w-full min-h-[16rem] bg-slate-50 border-4 border-dashed border-slate-200 rounded-[30px] cursor-pointer hover:bg-blue-50 hover:border-blue-200 transition-all overflow-hidden group">
                                    @if($soal->gambar)
                                        <div id="image-placeholder" class="hidden flex flex-col items-center justify-center pt-5 pb-6">
                                            <svg class="w-12 h-12 text-slate-300 mb-4 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                            <p class="text-sm text-slate-400 font-bold uppercase tracking-widest">Klik untuk ganti gambar</p>
                                        </div>
