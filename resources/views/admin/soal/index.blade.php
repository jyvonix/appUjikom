        ...
        <div class="max-w-[1600px] mx-auto px-4 sm:px-8 pt-10 space-y-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/40 backdrop-blur-md p-6 rounded-[2rem] border border-white shadow-sm">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="{{ route('admin.soal.kunci') }}" class="group inline-flex items-center gap-3 px-6 py-3.5 bg-white border-2 border-slate-100 text-slate-500 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm active:scale-95">
