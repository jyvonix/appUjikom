<x-guru-layout>
    <div class="relative min-h-screen pb-20 bg-slate-50/30">
        ...
        <div class="mb-16 px-4 sm:px-8 pt-10">
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                <div class="flex items-start gap-6 md:gap-10">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 font-bold text-lg md:text-xl mt-4 md:mt-6 max-w-lg leading-relaxed italic">Menambahkan butir soal baru ke dalam repositori materi ujian Anda.</p>
                    </div>
                </div>
        ...
        <form action="{{ route('guru.soal.store') }}" method="POST" class="px-4 sm:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-14">
                ...
                <!-- Left: Content Creator (Identical to Admin) -->
                ...
                <!-- Right: Config Panel (Identical to Admin) -->
                    ...
                    <div class="sticky top-10 space-y-12">
                            ...
                            <div class="relative z-10 text-center">
                                ...
                                <div class="space-y-10">
                                    ...
                                    <div class="pt-10 space-y-6">
                                        ...
                                        <a href="{{ route('guru.soal.index') }}" class="block w-full py-4 text-slate-500 font-black text-center text-[10px] uppercase tracking-[0.5em] hover:text-white transition-all group">
                        ...
                        <div class="bg-white rounded-[40px] p-8 md:p-10 border border-slate-100 shadow-xl relative overflow-hidden group">
                            ...
                            <div class="flex items-start gap-6 relative z-10">
                                ...
                                <div>
                                    <h4 class="text-[11px] font-black text-slate-800 uppercase tracking-widest leading-none mb-3">Guru Authority</h4>
                                    <p class="text-[11px] text-slate-400 font-bold leading-relaxed italic">"Setiap soal yang Anda tambahkan di sini hanya akan dapat diakses oleh Anda dan Administrator sistem."</p>
                                </div>
                            </div>
                        </div>
