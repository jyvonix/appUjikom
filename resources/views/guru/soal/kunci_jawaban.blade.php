<x-guru-layout>
    <div class="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div class="flex gap-4">
            ...
            <a href="{{ route('guru.modul.index') }}" class="px-6 py-3 bg-slate-900 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-indigo-600 transition-all shadow-lg active:scale-95 transform"> Kembali ke Modul Ujian</a>
        </div>
    </div>
