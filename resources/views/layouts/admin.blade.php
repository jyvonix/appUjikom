        ...
        <aside :class="sidebarOpen ? 'open' : ''" class="sidebar-float flex flex-col shadow-2xl">
            ...
            <nav class="flex-1 overflow-y-auto no-scrollbar py-4">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.jurusan.index') }}" class="nav-item-pro {{ request()->routeIs('admin.jurusan.*') ? 'active' : '' }}">
                ...
                <form method="POST" action="{{ route('logout') }}" id="logout-form-admin">
                    ...
                    <button type="button" 
                        onclick="event.preventDefault(); 
                            Swal.fire({
                                title: 'Keluar Sistem?',
                                text: 'Anda akan mengakhiri sesi administrator ini.',
                                icon: 'warning',
                                ...
                                customClass: {
                                    ...
                                    confirmButton: 'bg-slate-900 hover:bg-rose-600 text-white px-6 py-2.5 rounded-xl font-bold uppercase tracking-widest text-[10px] ml-3',
                        ...
                        class="w-full flex items-center justify-center gap-2 py-3 bg-slate-900 text-white rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:bg-rose-600 transition-all shadow-lg active:scale-95">
