        ...
        >
            <div class="flex flex-col h-full">
                ...
                <div class="p-4 mt-auto">
                    ...
                    <div class="mt-4 px-2">
                        <form method="POST" action="{{ route('logout') }}" id="logout-form-guru">
                            @csrf
                            <button type="button" 
                                onclick="event.preventDefault(); 
                                    Swal.fire({
                                        title: 'Keluar?',
                                        text: 'Apakah Anda yakin ingin mengakhiri sesi mengajar Anda?',
                                        icon: 'question',
                                        ...
                                        customClass: {
                                            ...
                                            confirmButton: 'bg-rose-600 hover:bg-rose-700 text-white px-6 py-2.5 rounded-xl font-bold uppercase tracking-widest text-[10px] ml-3',
                                            cancelButton: 'bg-slate-100 text-slate-400 px-6 py-2.5 rounded-xl font-bold uppercase tracking-widest text-[10px]'
                                        },
                                        buttonsStyling: false
                                    }).then((result) => {
                                        if (result.isConfirmed) {
                                            document.getElementById('logout-form-guru').submit();
                                        }
                                    });"
                                class="group flex items-center justify-center w-full py-3 bg-white border border-slate-200 rounded-2xl text-slate-400 hover:text-rose-600 hover:border-rose-200 hover:bg-rose-50 hover:shadow-lg hover:shadow-rose-100 transition-all duration-500">
